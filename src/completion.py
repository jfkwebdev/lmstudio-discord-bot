...
#openai.api_key = "miladystationtoonemillion" # no need for an API key
...
client = AsyncOpenAI(base_url = "http://localhost:1234/v1")
#client.base_url = "http://localhost:1234/v1" # point to the local server
#client.api_key = "miladystationtoonemillion" # no need for an API key
